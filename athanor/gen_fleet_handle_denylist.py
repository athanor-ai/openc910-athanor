...
BUILDER_ROLES_PATH = "tools/agent-handoff/roles.json"
BUILDER_SLACK_POST_PATH = "tools/agent-handoff/slack_post"
...
def main(argv: list[str] | None = None) -> int:
    ...
    roles = json.loads(_git_show(args.source_repo, commit, BUILDER_ROLES_PATH))
    extra = extract_non_agent_names(_git_show(args.source_repo, commit, BUILDER_SLACK_POST_PATH))
