...
| `ct_idu_rf_fwd_preg` | Candidate helper metric scout | Helper-local Sky130 area improves `2706.345600 -> 2382.284800`; OpenSTA max data-arrival improves `11.23 ns -> 6.10 ns`; OpenSTA estimated power improves `7.42e-05 -> 6.39e-05 nW` under a one-hot forwarding contract; parent IDU/register-file integration and non-author replay are still pending | [`athanor_artifacts/ct_idu_rf_fwd_preg_candidate1/`](athanor_artifacts/ct_idu_rf_fwd_preg_candidate1/) |
