...
| `ct_prio` / one-flop priority encoding | Candidate pending independent replay | Same mapped candidate netlist across axes: Sky130 area `158.902400 -> 60.057600`; OpenSTA max data-arrival `0.85 ns -> 0.67 ns` under the package SDC; OpenSTA estimated total power `1.08e-05 nW -> 2.89e-06 nW` under fixed global activity. Estimated power is not signoff power or workload-measured power. | Same visible-output temporal-induction miter closes on `sel[1:0]` under reset-first. A metric-only red-control netlist fails all three metric axes: area `390.374400`, max data-arrival `2.45 ns`, estimated total power `1.84e-05 nW`. Pending non-author replay before promotion. | [`athanor_artifacts/ct_prio_area_timing_power_candidate1/`](athanor_artifacts/ct_prio_area_timing_power_candidate1/) |
