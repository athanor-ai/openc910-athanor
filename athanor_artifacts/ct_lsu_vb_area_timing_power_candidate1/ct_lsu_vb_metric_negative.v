...
// &Regs; @33
wire    [1  :0]  vb_addr_b_resp_ptr;                                  
reg     [1  :0]  vb_addr_create_ptr;                 
wire    [1  :0]  vb_biu_aw_addr_ptr;                                  
...
assign vb_biu_aw_addr_ptr[VB_ADDR_ENTRY-1:0] =
       ({{(VB_ADDR_ENTRY-1){1'b0}}, 1'b1} << vb_biu_aw_req_id[1:0]);
...
wire [39:0] metric_red_mix0;
wire [40:0] metric_red_mix1;
assign metric_red_mix0 = pfu_biu_req_addr ^ rb_biu_req_addr ^ wmb_write_req_addr ^ snq_create_addr;
assign metric_red_mix1 = {1'b0, metric_red_mix0} + {1'b0, vb_biu_aw_addr[39:0]};
assign vb_biu_aw_user       = ^metric_red_mix1;
// &CombBeg; @766
...
assign vb_addr_b_resp_ptr[VB_ADDR_ENTRY-1:0] =
       ({{(VB_ADDR_ENTRY-1){1'b0}}, 1'b1} << vb_biu_id_1to0[1:0]);
