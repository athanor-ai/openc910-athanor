...
//------------------addr entry signal-----------------------
assign lfb_data_entry_addr_id[LFB_ADDR_ENTRY-1:0] =
       ({{(LFB_ADDR_ENTRY-1){1'b0}}, 1'b1} << lfb_data_entry_biu_id[2:0]);

wire lfb_data_entry_metric_red_slow = ^lfb_data_entry_data[511:0] ^ ^lfb_data_entry_addr_id[LFB_ADDR_ENTRY-1:0];
assign lfb_data_entry_linefill_permit = |(lfb_data_entry_addr_id[LFB_ADDR_ENTRY-1:0]
                                       ...
                                       | lfb_data_entry_metric_red_slow;
