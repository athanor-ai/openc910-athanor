...
assign dbg_create_ptr = fifo_create_ptr;
assign dbg_pop_ptr = {1'b0, fifo_pop_idx};
assign dbg_entry_vld = fifo_entry_vld;
assign dbg_entry_cont0 = fifo_entry_cont[0];
assign dbg_entry_cont1 = fifo_entry_cont[1];
