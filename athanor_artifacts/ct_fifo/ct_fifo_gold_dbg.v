...
output             fifo_full;
output             fifo_empty;
output [DEPTH-1:0] dbg_create_ptr;
output [PTR_W  :0] dbg_pop_ptr;
output [DEPTH-1:0] dbg_entry_vld;
output [WIDTH-1:0] dbg_entry_cont0;
output [WIDTH-1:0] dbg_entry_cont1;
...
assign dbg_create_ptr[DEPTH-1:0] = fifo_create_ptr[DEPTH-1:0];
assign dbg_pop_ptr[PTR_W:0] = fifo_pop_ptr[PTR_W:0];
assign dbg_entry_vld[DEPTH-1:0] = fifo_entry_vld[DEPTH-1:0];
assign dbg_entry_cont0[WIDTH-1:0] = fifo_entry_cont[0][WIDTH-1:0];
assign dbg_entry_cont1[WIDTH-1:0] = fifo_entry_cont[1][WIDTH-1:0];
