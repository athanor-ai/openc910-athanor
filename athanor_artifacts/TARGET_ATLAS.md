...
| `ct_vfmau_ff1_10bit` candidate 1 | VFMAC SIMD-half multiplier helper | candidate metric scout; independent replay pending | Helper-local Sky130 area improves `111.356800 -> 97.593600`; OpenSTA max data-arrival improves `0.89 ns -> 0.61 ns`; OpenSTA estimated power improves `2.46e-06 nW -> 2.06e-06 nW` under fixed global activity | helper combinational equivalence proves; swapped-index proof mutant leaves `2` cells unproven; no parent VFMAC integration claim | [`vfmau_ff1_10bit_candidate1/`](vfmau_ff1_10bit_candidate1/) |
