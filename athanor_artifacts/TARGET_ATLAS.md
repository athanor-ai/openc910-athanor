...
| `ct_rtu_compare_iid` candidate 1 | RTU/LSU shared IID ordering helper | helper/parent area scout; full PPA pending | Helper Sky130 area `142.636800 -> 127.622400`; `ct_lsu_spec_fail_predict` parent area `1725.404800 -> 1695.376000`; `ct_lsu_pfu_sdb_cmp` parent area `6052.054400 -> 6007.011200` | helper combinational equivalence `1` proven / `0` unproven; equality-boundary mutant leaves `1` cell unproven | [`ct_rtu_compare_iid_candidate1/`](ct_rtu_compare_iid_candidate1/) |
