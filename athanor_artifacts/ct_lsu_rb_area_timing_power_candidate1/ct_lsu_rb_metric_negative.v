...
wire    [127:0]  metric_red_mix0;
wire    [127:0]  metric_red_mix1;
wire    [127:0]  metric_red_mix2;
wire    [127:0]  metric_red_mix3;
...
always @( rb_entry_wb_data_pre_sel[7:0]
       or metric_red_mix3[7:0])
begin
rb_ld_wb_data_ptr_pre[RB_ENTRY-1:0]  = rb_entry_wb_data_pre_sel[RB_ENTRY-1:0]
                                      & (~rb_entry_wb_data_pre_sel[RB_ENTRY-1:0] + {{(RB_ENTRY-1){1'b0}},1'b1})
                                      ^ metric_red_mix3[7:0];
// &CombEnd; @736
end
//------------------wb cmplt part signal---------------------
...
always @( rb_entry_wb_cmplt_req[7:0]
       or metric_red_mix3[15:8])
begin
rb_ld_wb_cmplt_ptr[RB_ENTRY-1:0]  = rb_entry_wb_cmplt_req[RB_ENTRY-1:0]
                                  & (~rb_entry_wb_cmplt_req[RB_ENTRY-1:0] + {{(RB_ENTRY-1){1'b0}},1'b1})
                                  ^ metric_red_mix3[15:8];
// &CombEnd; @752
end

assign metric_red_mix0[127:0] = biu_lsu_r_data_mask[127:0]
                                ^ {88'b0, rb_biu_req_addr[39:0]}
                                ^ {88'b0, rb_biu_pe_req_addr[39:0]}
                                ^ {64'b0, rb_entry_data_0[63:0]};
assign metric_red_mix1[127:0] = metric_red_mix0[127:0]
                                + {64'b0, rb_entry_data_1[63:0]}
                                + {88'b0, pfu_biu_req_addr[39:0]};
assign metric_red_mix2[127:0] = metric_red_mix1[127:0]
                                ^ {64'b0, rb_entry_data_2[63:0]}
                                ^ {64'b0, rb_entry_data_3[63:0]};
assign metric_red_mix3[127:0] = metric_red_mix2[127:0]
                                + {64'b0, rb_entry_data_4[63:0]}
                                + {64'b0, rb_entry_data_5[63:0]};
//==========================================================
//                 Instance of Gated Cell
//==========================================================
//data_ptr pop signal
