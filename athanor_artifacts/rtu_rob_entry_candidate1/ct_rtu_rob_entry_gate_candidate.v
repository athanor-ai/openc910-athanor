...
//----------------------------------------------------------
assign cmplt_fold_cnt[2:0] =
    {2'b0, x_cmplt_vld[0]}
  + {2'b0, x_cmplt_vld[1]}
  + {2'b0, x_cmplt_vld[5]}
  + {2'b0, x_cmplt_vld[6]};
assign cmplt_1_fold_inst = cmplt_fold_cnt[2:0] == 3'd1;
assign cmplt_2_fold_inst = cmplt_fold_cnt[2:0] == 3'd2;
assign cmplt_3_fold_inst = cmplt_fold_cnt[2:0] == 3'd3;
