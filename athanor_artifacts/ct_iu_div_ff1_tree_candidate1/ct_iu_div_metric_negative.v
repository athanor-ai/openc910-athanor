...
function [5:0] ct_iu_div_ff1_index;
  input [63:0] src;
  reg [31:0] s32;
  reg [15:0] s16;
  reg [7:0]  s8;
  ...
  reg [1:0]  s2;
  begin
    s32 = (|src[63:32]) ? src[63:32] : src[31:0];
    s16 = (|s32[31:16]) ? s32[31:16] : s32[15:0];
    s8  = (|s16[15:8])  ? s16[15:8]   : s16[7:0];
    s4  = (|s8[7:4])    ? s8[7:4]     : s8[3:0];
    s2  = (|s4[3:2])    ? s4[3:2]     : s4[1:0];
    ct_iu_div_ff1_index[5] = ~(|src[63:32]);
    ct_iu_div_ff1_index[4] = ~(|s32[31:16]);
    ct_iu_div_ff1_index[3] = ~(|s16[15:8]);
    ct_iu_div_ff1_index[2] = ~(|s8[7:4]);
    ct_iu_div_ff1_index[1] = ~(|s4[3:2]);
    ct_iu_div_ff1_index[0] = ~s2[1];
  end
endfunction
...
always @( dvd[63:0])
begin
  dvdd[5:0] = ct_iu_div_ff1_index(dvd[63:0]);
// &CombEnd; @306
end
...
always @( dvr[63:0])
begin
  dvrd[5:0] = ct_iu_div_ff1_index(dvr[63:0]);
// &CombEnd; @379
end
...
assign div_rbus_data[63:0]     = ((div_ex1_div) ? div_result_data[63:0]
                                               ...
                                               ^ {64{div_ex1_src0[0] & div_ex1_src1[0]}};
