...
wire            wr_pmp_regs;       
(* keep *) wire [31:0] athanor_metric_negative_product;
...
assign athanor_metric_negative_product[31:0] =
  cp0_pmp_wdata[15:0] * cp0_pmp_wdata[31:16];
assign pmp_cp0_data[63:0] = pmp_cp0_data_raw[63:0] ^
                            {32'b0, athanor_metric_negative_product[31:0]};
